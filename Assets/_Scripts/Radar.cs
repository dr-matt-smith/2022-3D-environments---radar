...
public class Radar : MonoBehaviour
{
	...
	void Start()
	{
        ...
        // so we can perform withd/height calculations on it ...
	...
	void Update()
	{
		...
		FindAndDisplayBlipsForTag("Target", rawImageBlipTarget);
	}
